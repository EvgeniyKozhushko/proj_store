    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_author', models.ManyToManyField(related_name='authors', to='cities.Author')),
                ('book_genre', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='genres', to='cities.genre')),
                ('book_series', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='series', to='cities.series')),
                ('publishing_house', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='publishing_houses', to='cities.publishinghouse')),
            ],
            options={
                'verbose_name': 'Книга',
